<template>
	...
	<section class="bg-light" id="contact">
	  <div class="container">
	    <h2 class="text-center text-uppercase text-secondary mb-2">Get In Touch</h2>

	    <div class="row justify-content-center align-items-stretch gx-5">
	      <!-- Map -->
	      <div class="col-md-5 map-container mt-5 p-0">
	        <iframe
	          id="gmap_canvas"
	      ...
	      <div class="col-md-5 p-4 d-flex flex-column">
	        <form @submit.prevent="submitForm" id="contactForm" class="flex-fill">
	            ...
	            <div class="form-footer">
	                ...
	                <button type="submit" class="btn btn-primary btn-lg" :disabled="isLoading">{{isLoading ? "Sending..." : "Submit"}}</button>
	            </div>
